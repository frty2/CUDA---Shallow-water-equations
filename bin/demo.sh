...
./swegpu ../res/flood.yaml -roty 266 -rotx 20 -zoom 19 -wspf 40 -kernelflops 256
./swegpu ../res/tsunami.yaml -roty 225 -rotx 15 -zoom 15 -wspf 20 -kernelflops 256
./swegpu ../res/tsunami.yaml -rotx 8 -zoom 8 -roty 350 -wspf 20 -kernelflops 256
./swegpu ../res/tsunami.yaml -roty 225 -rotx 345 -zoom 15 -wspf 20 -kernelflops 256
